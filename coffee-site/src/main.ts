...
export const cityInfo = () => {
   ...
   <img class="map-img" src="../public/img/map.jpg" alt="map">
   </a>
</div>
</div>
    `
...
export const team = () => {
    return `
    <div class="team-wrapper border-bottom">
...
<button class="leave-comment btn">Оставьте заявку</button>
</div>
</div>
    `
}
...
export const footer = () => {
    ...
    <div class="img-wrapper"><img class="map-img" src="../public/img/map.jpg" alt="office"></div>
    <div class="date">
